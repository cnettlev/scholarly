...
#    'accept-language': 'en-US,en',
    'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:61.0) Gecko/20100101 Firefox/61.0',#'Mozilla/5.0 (X11; Linux x86_64; rv:27.0) Gecko/20100101 Firefox/27.0'',#AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/41.0.2272.76 Chrome/41.0.2272.76 Safari/537.36',
...
class Publication(object):
    ...
    def __init__(self, __data, querier, pubtype=None):
        self.bib = dict()
        self.source = pubtype
        self.citedby = 0
    ...
    def fill(self):
        ...
        if self.source == 'citations':
            ...
            bibtex = self.querier._get_page(self.url_scholarbib)
